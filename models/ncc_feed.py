...
NCC_CITY_PROFILES = {
    ...
    "Kaduna": {
        "description": "Northern industrial corridor, moderate harmattan, growing backbone",
        "osnr_db":     20.0,
        "latency_ms":  14.5,
        "ber":         1.1e-6,
        "power_dbm":   -1.8,
        ...
        "peak_hours":  [19, 20, 21],
        "peak_latency_multiplier": 1.3,
        "generator_failure_risk": 0.14,
    },
    "Enugu": {
        "description": "Eastern coal city, hilly terrain, moderate rain attenuation",
        "osnr_db":     20.3,
        "latency_ms":  13.5,
        "ber":         9e-7,
        "power_dbm":   -1.6,
        ...
        "peak_hours":  [18, 19, 20],
        "peak_latency_multiplier": 1.35,
        "generator_failure_risk": 0.11,
    },
    "Jos": {
        "description": "Highland plateau, cooler climate, lower congestion risk",
        "osnr_db":     21.2,
        "latency_ms":  12.5,
        "ber":         6e-7,
        "power_dbm":   -0.8,
        ...
        "peak_hours":  [19, 20],
        "peak_latency_multiplier": 1.2,
        "generator_failure_risk": 0.08,
    },
    "Ibadan": {
        "description": "South-western hub, Lagos-proximate humidity, expanding fibre",
        "osnr_db":     20.1,
        "latency_ms":  13.0,
        "ber":         1.0e-6,
        "power_dbm":   -1.7,
